                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="border p-4 rounded">
                                    ...
                                    <div class="form-body">
                                        <form class="row g-3" action="/admin/lost-password" method="post">
                                            @csrf
                                            <div class="col-12">
                                                <label class="form-label">Địa Chỉ Email</label>
                                                <input name="email" type="email" class="form-control" placeholder="Nhập vào địa chỉ email">
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-12">
                                                <div class="d-grid">
                                                    <button type="submit" class="btn btn-primary"><i class="bx bxs-lock-open"></i>Lấy Lại Mật Khẩu</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
